...
if __name__ == "__main__":
    ...
    options = {
        '1': (50, OUTPUTS_DIR / 'voynich_quick_50.txt'),
        '2': (200, OUTPUTS_DIR / 'voynich_quick_200.txt'),
        '3': (500, OUTPUTS_DIR / 'voynich_quick_500.txt'),
        '4': (1000, OUTPUTS_DIR / 'voynich_quick_1000.txt'),
    }
    
    if choice in options:
        max_w, output = options[choice]
        quick_analyze(DATA_DIR / 'voynich.nowhitespace.txt', output, max_w)
    else:
        print("기본값 (50단어) 실행")
        quick_analyze(DATA_DIR / 'voynich.nowhitespace.txt', OUTPUTS_DIR / 'voynich_quick_50.txt', 50)
